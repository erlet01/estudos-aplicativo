...
// ======================================================
// CALENDÁRIO COMPLETO E SINCRONIZADO
// ======================================================
...
// Função de busca no localStorage
...
// Renderiza os dias de qualquer mês
function renderFullCalendar() {
    ...
    // Preenche os espaços em branco antes do primeiro dia
    ...
    for (let day = 1; day <= lastDay; day++) {
        ...
        // Se estiver na página da Gran Faculdade, libera o clique para abrir o painel de criação
        if (isEditablePage) {
            dayEl.style.cursor = "pointer";
...
// Seleção de um dia (Exclusivo da página Gran Faculdade)
function selectCalendarDay(dateKey, day, month, year) {
    selectedDateKey = dateKey;
    renderFullCalendar(); // Atualiza a seleção visual do dia
...
// Carrega os compromissos do dia no painel
...
// Evento de Adicionar Novo Compromisso
...
if (btnAddEvent && eventInput) {
    btnAddEvent.addEventListener("click", () => {
        ...
        if (text && selectedDateKey) {
            ...
            eventInput.value = "";
            loadEventsForSelectedDay();
            renderFullCalendar(); // Atualiza a bolinha roxa no dia
        }
    });
}

// Troca de meses (Botões < e >)
